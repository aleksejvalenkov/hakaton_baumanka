...
sys.path.append('iq_pymavlink')

from iq_pymavlink.arm import arm
from sitl_simulator import SITLSimulator
from iq_pymavlink.change_mode import connect_to_sysid, change_mode
from iq_pymavlink.takeoff import takeoff
from iq_pymavlink.speed_yaw import set_speed, set_yaw
from iq_pymavlink.upload_waypoints import upload_qgc_mission
...
class TestAll(unittest.TestCase):
    ...
    def test_upload_waypoints(self):
        ...
        mission_file = os.path.join(os.path.dirname(__file__), "iq_pymavlink", "wps", "CMAC_square.plan")
